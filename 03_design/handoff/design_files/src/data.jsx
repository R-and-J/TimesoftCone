// Mock data — auctions, users, ledger entries, stake distribution.
// Names use realistic Korean — these are fictional employees in '타임소프트(주)'.

const ME = { id: 1, name: '김기철', emp: 'TS-2024-018', role: 'EMPLOYEE', team: '서비스플랫폼팀', wallet: 12450, stake_ratio: 0.087, contributed_days: 6 };
...
const AUCTIONS = [
  ...
  { id: 'A-2026-103', status: 'AWARDED', highest: 7800, bids: 18, my: true, winner: '김기철', end: '마감됨', endLabel: '어제 18:00 낙찰', leftBids: 0 },
  { id: 'A-2026-102', status: 'AWARDED', highest: 9400, bids: 27, my: false, winner: '이도현', end: '마감됨', endLabel: '4/1 (월) 낙찰', leftBids: 0 },
  { id: 'A-2026-101', status: 'UNSOLD', highest: 0, bids: 0, my: false, end: '유찰됨', endLabel: '3/31 유찰', leftBids: 0 },
];

// Live bidding screen — focused auction with realistic bid history
const FEATURED = {
  id: 'A-2026-106',
  title: '연차 1일권 #106',
  status: 'OPEN',
...
// Stake distribution for dividend screen
const STAKES = [
...
// Ledger entries for admin screen
const LEDGER = [
...
// Auction recent activity (mini feed)
const TICKER = [
...
Object.assign(window, { ME, TEAM, AUCTIONS, FEATURED, STAKES, LEDGER, TICKER });
