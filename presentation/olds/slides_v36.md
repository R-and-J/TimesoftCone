...
<!-- _class: lead -->
# ① 프로젝트 개요
**남는 연차와 부족한 연차를 잇다 — 회사·판매자·구매자 3-Way Win**
...
<!-- _class: lead -->
# ② 요구사항 분석
**경매(입찰·낙찰)가 핵심 · 적립금 정합성은 무결성 규칙으로 보장**
...
<!-- _class: lead -->
# ④ 소프트웨어 아키텍처
**포트 & 어댑터로 도메인 코어를 외부 변화에서 격리 (헥사고날 + 클린)**
...
<!-- _class: lead -->
# ⑤ 적용 디자인 패턴
**Adapter로 외부 교체 · Observer로 부수효과 분리 — 코드에 실재**
...
<!-- _class: lead -->
# ⑥ 역할 분담 + 14주차 구현 계획
**2인 크로스리뷰 체계 · 핵심 구현 완료, 14주차는 통합·시연**
...
<div style="position:absolute; left:52%; top:46%; transform:translate(-50%,-50%); text-align:center; white-space:nowrap;">
  <div style="font-size:60px; font-weight:800; color:#1f3a93; letter-spacing:2px; text-shadow:0 0 22px #fff,0 0 12px #fff,0 0 5px #fff;">감사합니다</div>
  <div style="font-size:24px; font-weight:600; color:#1f3a93; margin-top:12px; text-shadow:0 0 16px #fff,0 0 8px #fff;">질문 환영합니다</div>
</div>
