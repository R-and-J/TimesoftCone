...
![bg brightness:0.45](img/app-login.png)

<style scoped>
  h1 { color:#ffffff; font-size:2.8em; margin-bottom:0.1em; text-shadow:0 3px 20px rgba(0,0,0,.55); }
  h3 { color:#dbe6fb; font-weight:600; text-shadow:0 2px 12px rgba(0,0,0,.55); }
</style>
