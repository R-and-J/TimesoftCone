...
## 액트 3 · 스토어 상품관리 <span class="tag-new">NEW</span>
...
(700 × 430)
<small>
상품 표 (sku · 이름 · 브랜드 · 가격(콘) · 재고 · 카테고리)<br>
+ 「상품 추가」 + 활성/비활성 토글<br>
하단: 감사 로그 표
</small>
</div>
...
**관리자 권한**
- 상품 CRUD — sku · 이름 · 가격 · 재고 · 카테고리
- 활성/비활성 토글로 카탈로그 노출 제어
- 표시순서로 카테고리 내 정렬
...
**즉시 반영**
관리자가 비활성화 → 사용자 카탈로그에서 즉시 사라짐

<br>

<span class="xs">⏱ 1.5분</span>
